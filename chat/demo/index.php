            ...
            $(function(){
                ...
                var sendmessage = function() {
                    ...
                    switch(to) {
                        ...
                        default:
                            //发送私信
                            to_name = $("#onlinelist").find("option:selected").text();
                            msg = {"to":to,"to_name":to_name,"content":msg};
                            socket.emit('private_message',msg, function(data){
                                console.log(data)
                                if(data) {
                                    //alert(to_name+ '被你提出');
                                }
                ...
                socket.on('quit', function (msg)
                {
                    var json = $.parseJSON(msg);
                    console.log(msg);
                    var info = '<a href="#" class="name">' + json.nick_name + '</a> ' + json.content +'<br>';
                    $("#message").append(info);
                });
