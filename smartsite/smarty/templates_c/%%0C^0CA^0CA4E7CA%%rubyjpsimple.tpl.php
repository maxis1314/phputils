<?php /* Smarty version 2.6.18, created on 2009-09-11 05:26:53
         compiled from /home/likethewind/wx/app/view/admin/rubyjpsimple.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/home/likethewind/wx/app/view/admin/rubyjpsimple.tpl', 107, false),)), $this); ?>
<html>
<head>
...
<hr>
<form method=POST action="/self/admin/rubyjp/<?php echo ((is_array($_tmp=$this->_tpl_vars['last_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
/<?php echo ((is_array($_tmp=$this->_tpl_vars['post']['lang'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">
<a href="/self/admin/rubyjp/<?php echo ((is_array($_tmp=$this->_tpl_vars['last_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
/<?php echo ((is_array($_tmp=$this->_tpl_vars['post']['lang'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">SAVE</a>
...
</textarea><a href="/self/error/rd?url=<?php echo ((is_array($_tmp=$this->_tpl_vars['post']['url'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">[From..]</a>
...
/<?php echo ((is_array($_tmp=$this->_tpl_vars['post']['lang'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">				
		<a href="/self/error/rd?url=<?php echo ((is_array($_tmp=$this->_tpl_vars['post']['url'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">[From..]</a>
		<?php echo '
...
<?php echo '"=="en"){			
	...
	var url="http://localhost:5558/self/admin/getjapanese23/"+text+"/'; ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['post']['lang'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
/<?php echo '";
...
function loading(){
	if(needrefresh2){
		...
		var url="http://localhost:5558/self/admin/getjapanese/"+selected+"/'; ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['post']['lang'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
/<?php echo '";
		var url2="http://localhost:5558/self/admin/getjapanese23/"+selected+"/'; ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['post']['lang'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
/<?php echo '";
