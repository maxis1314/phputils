<?php /* Smarty version 2.6.18, created on 2010-06-15 23:31:31
         compiled from /home/likethewind/wx/app/view/qiye/template/normal/index.tpl */ ?>
<html> 
<head> 
<title>yrddd</title> 
<meta name="description" content="yrddd"> 
<meta name=keywords content="yrddd"> 
...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0"> 
  <tr> 
    <td height="40" background="a/bg03.jpg" id="webmainmenu" class="LanMu"><a class="LanMuText" href="/">网站首页</a> <img src='a/lmsplit.gif' class='LmSplit' align=absmiddle> <a class="LanMuText" id="lm9057453" href="/perweb/oplanmu.asp?lanmuid=9057453&userid=1276001&uname=test8899&lanmutype=单页图文" target="">公司简介</a> <img src='a/lmsplit.gif' class='LmSplit' align=absmiddle> <a class="LanMuText" id="lm9057454" href="/perweb/oplanmu.asp?lanmuid=9057454&userid=1276001&uname=test8899&lanmutype=图片" target="">公司图片</a> <img src='a/lmsplit.gif' class='LmSplit' align=absmiddle> <a class="LanMuText" id="lm9057455" href="/perweb/oplanmu.asp?lanmuid=9057455&userid=1276001&uname=test8899&lanmutype=文章" target="">企业动态</a> <img src='a/lmsplit.gif' class='LmSplit' align=absmiddle> <a class="LanMuText" id="lm9057456" href="/perweb/oplanmu.asp?lanmuid=9057456&userid=1276001&uname=test8899&lanmutype=产品供应" target="">产品展示</a> <img src='a/lmsplit.gif' class='LmSplit' align=absmiddle> <a class="LanMuText" id="lm9057457" href="/perweb/oplanmu.asp?lanmuid=9057457&userid=1276001&uname=test8899&lanmutype=招聘" target="">人才招聘</a> <img src='a/lmsplit.gif' class='LmSplit' align=absmiddle> <a class="LanMuText" id="lm9057458" href="/perweb/oplanmu.asp?lanmuid=9057458&userid=1276001&uname=test8899&lanmutype=留言" target="">给我留言</a></td> 
  </tr> 
  <tr> 
    <td height="172" background="a/modelbg01.jpg"><font size=6>yrddd</font></td> 
  </tr> 
</table> 
<table width="778" height="700" border="0" align="center" cellpadding="0" cellspacing="0"> 
  <tr> 
	...
	<table width="205" border="0" cellpadding="0" cellspacing="0"> 
      <tr><td> 
       <table width="100%" border="0" cellpadding="0" cellspacing="0" background="a/left01.gif"> 
      <tr> 
      ...
      <tr> 
        <td height="60" class="LeftBody"><table height='200' width='100%' cellspacing=0 cellpadding=3 border=0><tr><td valign=top style="line-height:150%;"> 
	...
	<table width="205" border="0" cellpadding="0" cellspacing="0"> 
      ...
      <tr> 
        <td height="60" class="LeftBody"><table height='180' width='100%' cellspacing=0 cellpadding=0 border=0><tr><td valign=top><table cellspacing=0 cellpadding=0 height=120 border=0 width='100%'><tr><td height='100%' align=center valign=top><br></td></tr></table><td></tr></table></td> 
      </tr> 
      <tr> 
        <td height="5"></td> 
      </tr> 
	...
	<table width="205" border="0" cellpadding="0" cellspacing="0"> 
      ...
      <tr> 
        <td height="60" class="LeftBody"><table height='200' width='100%' cellspacing=0 cellpadding=0 border=0><tr><td align="center" valign=""><table width="100%" align="center" border="0" cellspacing="1"  bgcolor="" cellpadding="0"></table></td></tr></table></td> 
      </tr> 
      <tr> 
        <td height="5"></td> 
      </tr> 
	...
	<table width="100%"  border="0" align="center" cellpadding="1" cellspacing="1"> 
           ...
           <tr><td align="center" valign="middle"><table width='100%' border='0' cellspacing='0' cellpadding='3' style='line-height:160%;'><tr><td valign=top>
			...
			<table width="360" border="0" cellspacing="0" cellpadding="0"> 
              <tr><td> 
              <table width="100%" border="0" cellpadding="0" cellspacing="0" background="a/img01.gif"> 
          <tr> 
            <td height="33"  class="MiddleFrame"><span>最新动态</span></td> 
			<td align="right" class="CenterMoreLink"> 
				  <img src="a/more.gif"  border="0"></td> 
          </tr></table> 
              </tr> 
              <tr> 
                <td height="60" class="MiddleBody">
...
?>
				<?php if ($this->_tpl_vars['item']['type'] == 'news'): ?>
			...
			<table width="360" border="0" cellspacing="0" cellpadding="0"> 
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" background="a/img01.gif"> 
          <tr> 
            <td height="33"  class="MiddleFrame"><span>公司图片</span></td> 
			<td align="right" class="CenterMoreLink"> 
				  <img src="a/more.gif"  border="0"></td> 
          </tr></table> 
              </tr> 
              <tr> 
                <td height="60" class="MiddleBody"><table height='200' width='100%' cellspacing=0 cellpadding=0 border=0><tr><td align="center" valign=""></td></tr></table></td> 
              </tr> 
              <tr> 
                <td height="5"></td> 
              </tr> 
			...
			<table width="360" border="0" cellspacing="0" cellpadding="0"> 
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" background="a/img01.gif"> 
          <tr> 
            <td height="33"  class="MiddleFrame"><span>最新产品</span></td> 
			<td align="right" class="CenterMoreLink"> 
				  <img src="a/more.gif"  border="0"></td> 
          </tr></table> 
              </tr> 
			...
			<table width="360" border="0" cellspacing="0" cellpadding="0"> 
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" background="a/img01.gif"> 
          <tr> 
            <td height="33"  class="MiddleFrame"><span>推荐产品</span></td> 
			<td align="right" class="CenterMoreLink"> 
				  <img src="a/more.gif"  border="0"></td> 
          </tr></table> 
              </tr> 
	...
	<table width="205" border="0" cellpadding="0" cellspacing="0"> 
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" background="a/left01.gif"> 
      <tr> 
        <td height="33"  class="LeftTitle"><span>文章排行</span></td> 
		 <td align="right" class="RightMoreLink">更多>></td> 
      </tr></table> 
      </tr> 
      <tr> 
        <td height="60" class="LeftBody"><table height='200' width='100%' cellspacing=0 cellpadding=0 border=0><tr><td align="center" valign=""></td></tr></table></td> 
      </tr> 
      <tr> 
        <td height="5"></td> 
      </tr> 
	...
	<table width="205" border="0" cellpadding="0" cellspacing="0"> 
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" background="a/left01.gif"> 
      <tr> 
        <td height="33"  class="LeftTitle"><span>网站调查</span></td> 
		 <td align="right" class="RightMoreLink"></td> 
      </tr></table> 
      </tr> 
      <tr> 
        <td height="60" class="LeftBody"><table height='200' width='100%' cellspacing=0 cellpadding=0 border=0><tr><td valign=top><table width='95%' border=0 cellspacing=0 cellpadding=0><form method='post' action='/perweb/subdiaocha.asp' name='diaochaform' id='diaochaformid' target=domydiaocha><tr><td height=4></td></tr><tr><td align=left height=24 style='line-height:140%;color:;font-family:宋体;font-size:12px;font-style:;font-weight:;text-decoration:none;'>请输入调查主题</td></tr><tr><td height=45 align=center><input type='button' class='WebButtonStyle' name='Submitdiaocha' value='投 票' onclick="javascript:domydiaochawin=window.open('','domydiaocha','toolbar=no,menubar=no,resizable=no,location=no,status=no,width=300,height=200,top=0,left=0');document.getElementById('diaochaformid').submit();domydiaochawin.focus();">&nbsp;&nbsp;&nbsp;&nbsp;<input type='button' class='WebButtonStyle' onclick="javascript:viewmydiaochawin=window.open('/perweb/viewdiaoresult.asp?uname=test8899','viewmydiaocha','toolbar=no,menubar=no,resizable=no,location=no,status=no,width=400,height=300,top=0,left=0');viewmydiaochawin.focus();" name='viewdiaocha' value='查 看'><input type=hidden name=uname value=test8899></td></tr></form></table><td></tr></table></td> 
      </tr> 
      <tr> 
        <td height="5"></td> 
      </tr> 
