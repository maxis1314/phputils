...
<!-- Mirrored from web.hichina.com/sitemanager/templet/009/left1/ by HTTrack Website Copier/3.x [XR&CO'2003], Thu, 28 Aug 2003 00:01:45 GMT -->
<HEAD>
<TITLE>
<!--Your Company Name-->
Template
...
<BODY BGCOLOR=#990000 leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" class="leftbg" LANGUAGE=javascript onload="return window_onload()">
<!--Counter-->
<!--Something Here-->
<table width="778" border="0" cellspacing="0" cellpadding="0" align="center" height="130">
  <tr> 
    <td rowspan="2" width="220" height="130"><img src="images/index_top1.gif" width="220" height="130"></td>
    <td colspan="3" height="38"><img src="images/index_top2.gif" width="558" height="38"></td>
  </tr>
  <tr> 
    <td width="354" height="90" background="images/index_top3.gif"> 
...
Nin de gong si ming cheng
</b></font></div>
          </td>
        </tr>
      </table>
    </td>
    <td width="186" height="90"><img src="images/01.gif" width="186" height="92"></td>
    <td width="18" height="90"><img src="images/index_top4.gif" width="18" height="92"></td>
  </tr>
</table>
        ...
        <tr> 
          <td width="174" valign="top"> 
            <table width="174" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><img src="images/index_lmtop.gif" width="174" height="22"></td>
              </tr>
              <tr> 
                <td> 
                  <table width="174" border="0" cellspacing="0" cellpadding="0" background="images/index_lmbg.gif">
...
<!--Something Here-->
                    ...
                    <tr> 
                      <td height="36"> 
                        <table width="174" border="0" cellspacing="0" cellpadding="0" height="32" background="images/index_lm.gif">
                          <tr> 
                            <td>
                              <table width="174" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="27">&nbsp;</td>
                                  <td width="147">
                                    <div align="center"><b><a href="index.htm"><font color="#FFFFFF">首页 
                                      </font></a></b></div>
                                  </td>
                                </tr>
                              </table>
...
<!--Button10.Content.End-->
              ...
              <tr> 
                <td><img src="images/index_lmbuttom.gif" width="174" height="100"></td>
              </tr>
            </table>
          </td>
          <td valign="top"> 
...
<br>
                        ...
                        <br>
                        <br>
                        <a href="http://www.aspjzy.com" target="_blank">ASP集中营</a><br>
                  这只是一个让您观看效果的临时页面，在这里您可以看到您的公司名称、描述、栏目的名称等等，一切您输入的东西都可以动态的在这里显示出来。<br>
                  <br>
                  <br>
                  如果您觉得这样的页面效果不理想，您可以尝试变换页面栏目的左右放置方式、页面的颜色，直至更换另一个您喜欢的模板。 <br>
                        <br>
                        <b><font size="3"><embed src="../../../../banner.swf" quality=high width="480" height="60"></embed></font></b><b><font size="3"> </font></b>
<!--Something Here-->
<!--Page.Content.End-->
</td>
                    </tr>
...
<table width="778" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td><img src="images/index_bottom.gif" width="778" height="41"></td>
  </tr>
</table>
</BODY>
