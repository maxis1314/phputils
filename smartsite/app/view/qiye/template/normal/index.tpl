...
{foreach name=foo from=$list item=item}
	...
	<table width="205" border="0" cellpadding="0" cellspacing="0"> 
      ...
      <tr> 
        <td  class="LeftBody"><table  width='100%' cellspacing=0 cellpadding=0 border=0><tr><td valign=top>
	...
	<table width="100%"  border="0" align="center" cellpadding="1" cellspacing="1"> 
           ...
           <tr><td align="center" valign="middle"><table width='100%' border='0' cellspacing='0' cellpadding='3' style='line-height:160%;'><tr><td valign=top>
			...
			<table width="360" border="0" cellspacing="0" cellpadding="0"> 
              <tr><td> 
              <table width="100%" border="0" cellpadding="0" cellspacing="0" background="/public/template/normal/img01.gif"> 
          <tr> 
            <td height="33"  class="MiddleFrame"><span>最新动态</span></td> 
			<td align="right" class="CenterMoreLink"> 
				  <img src="/public/template/normal/more.gif"  border="0"></td> 
          </tr></table> 
              </tr> 
              <tr> 
          ...
          <tr> 
			...
			<td align="right" class="CenterMoreLink"> 
              ...
              <tr> 
                <td  class="MiddleBody"><table  width='100%' cellspacing=0 cellpadding=3 border=0>
...
{/foreach}
	...
	<table width="205" border="0" cellpadding="0" cellspacing="0"> 
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" background="/public/template/normal/left01.gif"> 
      <tr> 
        <td   class="LeftTitle"><span>文章排行</span></td> 
